    ...
    <main>
        <section>
            <form action="register_products.php" method="post">
                <div class="line_one">
                    <input type="text" id="bookName" name="bookName" placeholder="Nome do Livro" required>
                ...
                <input type="text" id="full_name" name="full_name" placeholder="Fornecedor" required>    
