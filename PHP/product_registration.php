...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/product_registration.css" media="screen" />
...
<body>
    ...
    <main>
        <section>
            <form action="">
                <div class="line_one">
                    <input type="text" id="book_name" name="book_name" placeholder="Nome do Livro">
                    <input type="number" id="price" name="price" placeholder="Preço">
                    <input type="text" id="quantity" name="quantity" placeholder="Quantidade">
                </div>

                <input type="text" id="supplier" name="supplier" placeholder="Fornecedor">    
